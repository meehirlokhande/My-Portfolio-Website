      ...
      <div className="pt-20  px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          <div className="flex flex-col sm:flex-row sm:justify-between items-center">
            <h1 className="text-2xl sm:text-4xl font-worksans font-semibold text-wood mb-4 sm:mb-0 text-center sm:text-left">
              My Achievements
            </h1>
            <div className="flex gap-4 items-center p-1 justify-center sm:justify-end">
              <a href="https://www.linkedin.com/in/meehirlokhande" className="hover:opacity-80 transition-opacity">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
              ...
              <a href="https://www.geeksforgeeks.org/user/meehirlokhande/" className="hover:opacity-80 transition-opacity">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a href="https://github.com/meehirlokhande" className="hover:opacity-80 transition-opacity">
